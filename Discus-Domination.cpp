...
int main(){
    int n, m, distance, greaterDistance, positions[MAXN + 1], positionDebbie, indexDebbie = 1, indexInsert = 1, scores;
    ...
    while (n > 1)
    {
        ...
        positionDebbie = positions[indexDebbie++];
        n--; 
    }
