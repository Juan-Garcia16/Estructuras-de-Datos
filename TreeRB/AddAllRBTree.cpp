...
//es una solucion mas rapida que arboles binarios de busqueda simple
int main(){
    ...
    while (scanf("%d", &n) && (n > 0))
    {
        ...
        for (idElement = 1; idElement < n; idElement++)
        {
            ...
            T = RB_Delete(T, z);
            result += element;
            T = RB_Insert(T, element); //element es la suma de los dos elemento smas pequenos en este momento
        }
