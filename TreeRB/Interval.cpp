...
int main(){
    ...
    for (idCase = 1; idCase <= totalCases; idCase++)
    {
        ...
        {
            scanf("%d", &element);
            z = TreeSearch(T, element); //para verficar si ya esta
            if(z->key != NILKey)
        ...
        //no estan en el dominio del problema, por lo cual sirve como valor maximo y minimo
        T = RB_Insert(T, -1);
